  ...
  return (
    <aside className={cn("flex flex-col bg-[#0a0a09]", className)} {...props}>
      ...
      <div className="px-5 pt-6 pb-5 flex items-center gap-2.5">
        ...
        <span className="font-mono-ui text-sm font-bold tracking-tight text-white">InstaxAgent</span>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5">
        ...
        <a
          href="https://github.com/iameterna00/instax-agent/issues"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 px-3 py-2 rounded-md text-[13px] text-neutral-500 hover:text-neutral-200 hover:bg-white/[0.03] transition-colors"
        >

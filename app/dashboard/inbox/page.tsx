...
export default function InboxPage() {
    ...
    return (
        <div className="relative flex h-[calc(100vh-4rem)] overflow-hidden border-border bg-background md:m-6 md:h-[calc(100vh-3rem)] md:rounded-xl md:border">
            {/* Left Sidebar: Conversation List */}
            <div className={cn(
                "w-full md:w-[340px] flex-shrink-0 border-r border-border bg-card/50 absolute md:static inset-0 z-10 transition-transform duration-300 md:translate-x-0 h-full",
